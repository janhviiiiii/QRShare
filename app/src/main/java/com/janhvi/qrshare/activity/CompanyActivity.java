...
public class CompanyActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private RelativeLayout rlCompanyActivity;
    private TextInputEditText etName, etEmail, etAddress, etContact, etWebsite;
    ...
    private void initUI() {
        rlCompanyActivity = findViewById(R.id.rlCompanyActivity);
    ...
    private void onClickBtnSubmit() throws WriterException {
        View[] view = {etName, etEmail, etContact, etAddress, etWebsite};
        if (Helper.isEmptyFieldValidation(view) && Helper.isContactValid(etContact) && Helper.isEmailValid(etEmail)) {
            String content = "Company name: " + Helper.getStringFromInput(etName) +
                    ...
                    "\nWebsite: " + Helper.getStringFromInput(etWebsite);
//            String content = Helper.getStringFromInput(etText);
            ...
            if (bitmap != null) {
                ...
                if (result != -1) {
                    ...
                    Helper.makeSnackBar(rlCompanyActivity, "Failed to generate QR Code");
                }
            } else {
                Helper.makeSnackBar(rlCompanyActivity, "Error generating QR code");
            }
        }
    }
}