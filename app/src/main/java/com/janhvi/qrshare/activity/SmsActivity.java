...
public class SmsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private RelativeLayout rlSmsActivity;
    private TextInputEditText etPhoneNo, etMsg;
    ...
    private void initUI() {
        rlSmsActivity = findViewById(R.id.rlSmsActivity);
    ...
    private void onClickBtnSubmit() throws WriterException {
        View[] view = {etPhoneNo, etMsg};
        if (Helper.isEmptyFieldValidation(view) && Helper.isContactValid(etPhoneNo)) {
            String content = "SMS:\nTo: " + Helper.getStringFromInput(etPhoneNo) +
                    "\nMessage: " + Helper.getStringFromInput(etMsg);
//            String content = Helper.getStringFromInput(etText);
            ...
            if (bitmap != null) {
                ...
                if (result != -1) {
                    ...
                    Helper.makeSnackBar(rlSmsActivity, "Failed to generate QR Code");
                }
            } else {
                Helper.makeSnackBar(rlSmsActivity, "Error generating QR code");
            }
        }
    }
