...
public class InstagramLinkFragment extends Fragment {

    private TextInputEditText etProfileLink;
    private AppCompatButton btnGenerate;
    private RelativeLayout rootLayout;
    private Context context;
    private DbHelper dbHelper;

    public InstagramLinkFragment() {
        super(R.layout.fragment_instagram_link); // layout file defined below
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        etProfileLink = view.findViewById(R.id.etProfileLink);
        btnGenerate = view.findViewById(R.id.btnSubmit);
        rootLayout = view.findViewById(R.id.rlFragmentInstagramLink);
    ...
    private void generateQRCode() {
        if (Helper.isEmptyFieldValidation(new View[]{etProfileLink})) {
            String content = Helper.getStringFromInput(etProfileLink).trim();
