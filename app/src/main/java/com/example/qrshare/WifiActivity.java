...
public class WifiActivity extends AppCompatActivity {
    ...
    private EditText etxt_network_name;
    private EditText etxt_password;
    private RadioGroup rg_network_type;
    private RadioButton wpa_wpa2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etxt_network_name = findViewById(R.id.etxt_network_name);
        etxt_password = findViewById(R.id.etxt_password);
        rg_network_type = findViewById(R.id.rg_network_type);
        wpa_wpa2 = findViewById(R.id.wpa_wpa2);
        ...
        btn_create.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String networkName = etxt_network_name.getText().toString();
                String password = etxt_password.getText().toString();
                int selectedNetworkType = rg_network_type.getCheckedRadioButtonId();
                RadioButton radioButton = findViewById(selectedNetworkType);


                if(networkName.trim().isEmpty() || password.trim().isEmpty()) {
                    Toast.makeText(WifiActivity.this, "Please fill all Mandatory fields", Toast.LENGTH_SHORT).show();
                }
                else{

                    String encryptionType = radioButton.getText().toString();
                    String wifiInfo = "BEGIN:WIFI\n" +
                            "NETWORK NAME:" + networkName + ";\n" +
                            "PASSWORD:" + password + "\n" +
                            "TYPE:" + encryptionType + "\n" +
                            "END:WIFI;"+"\n";
                    try{
                        bitmap = textToImageEncode(wifiInfo);
                        ...
                        databaseHelper.insertQRCode(wifiInfo, "GENERATED : WiFi", timestamp, imageByteArray);
                        ...
                        btn_download.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (ContextCompat.checkSelfPermission(WifiActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                        ...
                        btn_web_search.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.com/search?q="+"WIFI:S:"+networkName+";T:"+encryptionType+";P:"+password+";;"));
                                startActivity(i);
                            }
                        });
                        ...
                        btn_favorite.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                boolean isSuccess = databaseHelper.markAsFavorite(wifiInfo, imageByteArray);
                                if (isSuccess) {
                                    // If successfully added to favorites, show a toast message
                                    Toast.makeText(WifiActivity.this, "Added to Favorites", Toast.LENGTH_SHORT).show();
                                } else {
                                    // If failed to add to favorites, show an error message
                                    Toast.makeText(WifiActivity.this, "Failed to add to Favorites", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                        ...
                        btn_share.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (bitmap != null) {
                                    ...
                                    Uri uri = getImageUri(WifiActivity.this, bitmap);
                                    ...
                                    Toast.makeText(WifiActivity.this, "Generate a QR code first", Toast.LENGTH_SHORT).show();
                                }
                            }

                            // Method to get the URI of the bitmap
                            private Uri getImageUri(WifiActivity textActivity, Bitmap bitmap) {
                        ...
                        e.printStackTrace();
                        Toast.makeText(WifiActivity.this, "Failed to generate QR code", Toast.LENGTH_SHORT).show();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_WRITE_EXTERNAL_STORAGE) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(WifiActivity.this, "Permission denied, unable to save image", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void saveImageToGallery(Bitmap bitmap) {
        ...
        try {
            ...
            Toast.makeText(WifiActivity.this, "Saved to Device", Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
            e.printStackTrace();
            Toast.makeText(WifiActivity.this, "Failed to save image", Toast.LENGTH_SHORT).show();
        }
    }
