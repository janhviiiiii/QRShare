...
public class SMSActivity extends AppCompatActivity {
        ...
        btn_create.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(phoneNumber.trim().isEmpty() || message.trim().isEmpty()) {
                    Toast.makeText(SMSActivity.this, "Please fill all Mandatory fields", Toast.LENGTH_SHORT).show();
                }
                else{
                    ...
                    String smsInfo = "SMS: "+"\n"+
                            ...
                            "message: " + message+"\n";
                    try{
                        bitmap = textToImageEncode(smsInfo);
                        ...
                        databaseHelper.insertQRCode(smsInfo, "GENERATED : SMS", timestamp, imageByteArray);
                        ...
                        btn_download.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (ContextCompat.checkSelfPermission(SMSActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                        ...
                        btn_web_search.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.com/search?q="+smsInfo));
                                startActivity(i);
                            }
                        });
                        ...
                        btn_favorite.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                boolean isSuccess = databaseHelper.markAsFavorite(smsInfo, imageByteArray);
                                if (isSuccess) {
                                    // If successfully added to favorites, show a toast message
                                    Toast.makeText(SMSActivity.this, "Added to Favorites", Toast.LENGTH_SHORT).show();
                                } else {
                                    // If failed to add to favorites, show an error message
                                    Toast.makeText(SMSActivity.this, "Failed to add to Favorites", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                        ...
                        btn_share.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (bitmap != null) {
                                    ...
                                    Uri uri = getImageUri(SMSActivity.this, bitmap);
                                    ...
                                    Toast.makeText(SMSActivity.this, "Generate a QR code first", Toast.LENGTH_SHORT).show();
                                }
                            }

                            // Method to get the URI of the bitmap
                            private Uri getImageUri(SMSActivity textActivity, Bitmap bitmap) {
                        ...
                        e.printStackTrace();
                        Toast.makeText(SMSActivity.this, "Failed to generate QR code", Toast.LENGTH_SHORT).show();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_WRITE_EXTERNAL_STORAGE) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(SMSActivity.this, "Permission denied, unable to save image", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void saveImageToGallery(Bitmap bitmap) {
        ...
        try {
            ...
            Toast.makeText(SMSActivity.this, "Saved to Device", Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
            e.printStackTrace();
            Toast.makeText(SMSActivity.this, "Failed to save image", Toast.LENGTH_SHORT).show();
        }
    }
