...
public class EmailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etxt_subject = findViewById(R.id.etxt_subject);
        etxt_content = findViewById(R.id.etxt_content);
        ...
        btn_create.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String subject = etxt_subject.getText().toString();
                String content = etxt_content.getText().toString();


                if(email.trim().isEmpty()) {
                    Toast.makeText(EmailActivity.this, "Please enter email address", Toast.LENGTH_SHORT).show();
                }
                else{
                    ...
                    if (!content.trim().isEmpty()) {
                        emailInfo += "&body=" + content+"\n";
                    }

                    try{
                        bitmap = textToImageEncode(emailInfo);
                        ...
                        databaseHelper.insertQRCode(emailInfo, "GENERATED : Email", timestamp, imageByteArray);
                        ...
                        btn_download.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (ContextCompat.checkSelfPermission(EmailActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                        ...
                        String finalEmailInfo = emailInfo;

                        //method for btn_web_search
                        btn_web_search.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.com/search?q="+finalEmailInfo));
                                startActivity(i);
                            }
                        });
                        ...
                        btn_favorite.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                boolean isSuccess = databaseHelper.markAsFavorite(finalEmailInfo, imageByteArray);
                                if (isSuccess) {
                                    // If successfully added to favorites, show a toast message
                                    Toast.makeText(EmailActivity.this, "Added to Favorites", Toast.LENGTH_SHORT).show();
                                } else {
                                    // If failed to add to favorites, show an error message
                                    Toast.makeText(EmailActivity.this, "Failed to add to Favorites", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                        ...
                        btn_share.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (bitmap != null) {
                                    ...
                                    Uri uri = getImageUri(EmailActivity.this, bitmap);
                                    ...
                                    Toast.makeText(EmailActivity.this, "Generate a QR code first", Toast.LENGTH_SHORT).show();
                                }
                            }

                            // Method to get the URI of the bitmap
                            private Uri getImageUri(EmailActivity textActivity, Bitmap bitmap) {
                        ...
                        e.printStackTrace();
                        Toast.makeText(EmailActivity.this, "Failed to generate QR code", Toast.LENGTH_SHORT).show();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_WRITE_EXTERNAL_STORAGE) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(EmailActivity.this, "Permission denied, unable to save image", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void saveImageToGallery(Bitmap bitmap) {
        ...
        try {
            ...
            Toast.makeText(EmailActivity.this, "Saved to Device", Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
            e.printStackTrace();
            Toast.makeText(EmailActivity.this, "Failed to save image", Toast.LENGTH_SHORT).show();
        }
    }
