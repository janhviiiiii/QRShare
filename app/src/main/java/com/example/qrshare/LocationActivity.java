...
public class LocationActivity extends AppCompatActivity {
    ...
    private EditText etxt_latitude;
    private EditText  etxt_longitude;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etxt_latitude = findViewById(R.id.etxt_latitude);
        etxt_longitude = findViewById(R.id.etxt_longitude);
        ...
        btn_create.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String latitude = etxt_latitude.getText().toString();
                String longitude = etxt_longitude.getText().toString();


                if(latitude.trim().isEmpty() || longitude.trim().isEmpty()) {
                    Toast.makeText(LocationActivity.this, "Please fill all Mandatory fields", Toast.LENGTH_SHORT).show();
                }
                else{
                    ...
                    try{
                        bitmap = textToImageEncode(locationInfo);
                        ...
                        databaseHelper.insertQRCode(locationInfo, "GENERATED : Location", timestamp, imageByteArray);
                        ...
                        btn_web_search.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.com/search?q="+locationInfo));
                                startActivity(i);
                            }
                        });
                        ...
                        btn_favorite.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                boolean isSuccess = databaseHelper.markAsFavorite(locationInfo, imageByteArray);
                                if (isSuccess) {
                                    // If successfully added to favorites, show a toast message
                                    Toast.makeText(LocationActivity.this, "Added to Favorites", Toast.LENGTH_SHORT).show();
                                } else {
                                    // If failed to add to favorites, show an error message
                                    Toast.makeText(LocationActivity.this, "Failed to add to Favorites", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                        ...
                        btn_share.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (bitmap != null) {
                                    ...
                                    Uri uri = getImageUri(LocationActivity.this, bitmap);
                                    ...
                                    Toast.makeText(LocationActivity.this, "Generate a QR code first", Toast.LENGTH_SHORT).show();
                                }
                            }

                            // Method to get the URI of the bitmap
                            private Uri getImageUri(LocationActivity textActivity, Bitmap bitmap) {
                        ...
                        e.printStackTrace();
                        Toast.makeText(LocationActivity.this, "Failed to generate QR code", Toast.LENGTH_SHORT).show();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_WRITE_EXTERNAL_STORAGE) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(LocationActivity.this, "Permission denied, unable to save image", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void saveImageToGallery(Bitmap bitmap) {
        ...
        try {
            ...
            Toast.makeText(LocationActivity.this, "Saved to Device", Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
            e.printStackTrace();
            Toast.makeText(LocationActivity.this, "Failed to save image", Toast.LENGTH_SHORT).show();
        }
    }
