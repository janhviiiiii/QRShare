...
public class ProfileActivity extends AppCompatActivity {
    ...
    private EditText etxt_job_title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etxt_job_title = findViewById(R.id.etxt_job_title);
        ...
        btn_create.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String jobTitle = etxt_job_title.getText().toString();
                ...
                if(name.trim().isEmpty() || phoneNo.trim().isEmpty()) {
                    ...
                    String profileInfo = "BEGIN:PROFILE\n" +
                            "NAME:" + name + "\n" +
                            "PHONE NO:" + phoneNo + "\n" +
                            "EMAIL:" + email + "\n" +
                    ...
                    try{
                        bitmap = textToImageEncode(profileInfo);
                        ...
                        databaseHelper.insertQRCode(profileInfo, "GENERATED : Profile", timestamp, imageByteArray);
                        ...
                        btn_web_search.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.com/search?q="+profileInfo));
                                startActivity(i);
                            }
                        });
                        ...
                        btn_favorite.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                boolean isSuccess = databaseHelper.markAsFavorite(profileInfo, imageByteArray);
                                if (isSuccess) {
                                    ...
                                    Toast.makeText(ProfileActivity.this, "Failed to add to Favorites", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                        ...
                        btn_share.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (bitmap != null) {
                                    ...
                                    Uri uri = getImageUri(ProfileActivity.this, bitmap);
                                    ...
                                    Toast.makeText(ProfileActivity.this, "Generate a QR code first", Toast.LENGTH_SHORT).show();
                                }
                            }

                            // Method to get the URI of the bitmap
                            private Uri getImageUri(ProfileActivity textActivity, Bitmap bitmap) {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_WRITE_EXTERNAL_STORAGE) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(ProfileActivity.this, "Permission denied, unable to save image", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void saveImageToGallery(Bitmap bitmap) {
        ...
        try {
            ...
            Toast.makeText(ProfileActivity.this, "Saved to Device", Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
            e.printStackTrace();
