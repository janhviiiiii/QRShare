...
public class CompanyActivity extends AppCompatActivity {
    ...
    private EditText etxt_company_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etxt_company_name = findViewById(R.id.etxt_company_name);
        etxt_email = findViewById(R.id.etxt_email);
        etxt_contact = findViewById(R.id.etxt_contact);
        ...
        btn_create.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String companyName = etxt_company_name.getText().toString();
                String email = etxt_email.getText().toString();
                String contact = etxt_contact.getText().toString();
                String address = etxt_address.getText().toString();


                if(companyName.trim().isEmpty() || email.trim().isEmpty()|| contact.trim().isEmpty()) {
                    Toast.makeText(CompanyActivity.this, "Please fill all Mandatory fields", Toast.LENGTH_SHORT).show();
                }
                else{
                    String companyInfo = "BEGIN:COMPANY\n" +
                            ...
                            "END:COMPANY"+"\n";
                    try{
                        bitmap = textToImageEncode(companyInfo);
                        ...
                        databaseHelper.insertQRCode(companyInfo, "GENERATED : Company", timestamp, imageByteArray);
                        ...
                        btn_download.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (ContextCompat.checkSelfPermission(CompanyActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                        ...
                        btn_web_search.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.com/search?q="+companyInfo));
                                startActivity(i);
                            }
                        });
                        ...
                        btn_favorite.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                boolean isSuccess = databaseHelper.markAsFavorite(companyInfo, imageByteArray);
                                if (isSuccess) {
                                    // If successfully added to favorites, show a toast message
                                    Toast.makeText(CompanyActivity.this, "Added to Favorites", Toast.LENGTH_SHORT).show();
                                } else {
                                    // If failed to add to favorites, show an error message
                                    Toast.makeText(CompanyActivity.this, "Failed to add to Favorites", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                        ...
                        btn_share.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (bitmap != null) {
                                    ...
                                    Uri uri = getImageUri(CompanyActivity.this, bitmap);
                                    ...
                                    Toast.makeText(CompanyActivity.this, "Generate a QR code first", Toast.LENGTH_SHORT).show();
                                }
                            }

                            // Method to get the URI of the bitmap
                            private Uri getImageUri(CompanyActivity textActivity, Bitmap bitmap) {
                        ...
                        e.printStackTrace();
                        Toast.makeText(CompanyActivity.this, "Failed to generate QR code", Toast.LENGTH_SHORT).show();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_WRITE_EXTERNAL_STORAGE) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(CompanyActivity.this, "Permission denied, unable to save image", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void saveImageToGallery(Bitmap bitmap) {
        ...
        try {
            ...
            Toast.makeText(CompanyActivity.this, "Saved to Device", Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
            e.printStackTrace();
            Toast.makeText(CompanyActivity.this, "Failed to save image", Toast.LENGTH_SHORT).show();
        }
    }
